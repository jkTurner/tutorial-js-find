...
export default function Home() {
	return (
		<div className="flex flex-col w-full max-w-[1280px] h-[60vh] justify-center items-center mx-auto">
			<h1 className="font-semibold text-lg mb-4">React JS Find Method Tutorial</h1>
			<p className="opacity-70 mb-4 w-[400px] text-center">Practice how to use the .find() method with live React examples from simple value checks to searching within nested project data.
</p>
